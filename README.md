...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| @foadonis/actions      | [![npm version](https://img.shields.io/npm/v/@foadonis/actions?color=brightgreen)](https://npmjs.com/package/@foadonis/actions)           | Adonis library to safely store your secrets in your repository                                       | [Source](https://github.com/FriendsOfAdonis/FriendsOfAdonis/tree/main/packages/actions)      | [Documentation](https://friendsofadonis.com/docs/actions)      |
| @foadonis/autoloader   | [![npm version](https://img.shields.io/npm/v/@foadonis/autoloader?color=brightgreen)](https://npmjs.com/package/@foadonis/autoloader)     | Autoload modules with HMR support                                                                    | [Source](https://github.com/FriendsOfAdonis/FriendsOfAdonis/tree/main/packages/autoloader)   | [Documentation](https://friendsofadonis.com/docs/autoloader)   |
...
| @foadonis/flick        | [![npm version](https://img.shields.io/npm/v/@foadonis/flick?color=brightgreen)](https://npmjs.com/package/@foadonis/flick)               | Feature-flags management package for AdonisJS                                                        | [Source](https://github.com/FriendsOfAdonis/FriendsOfAdonis/tree/main/packages/flick)        | [Documentation](https://friendsofadonis.com/docs/flick)        |
...
| @foadonis/sentinel     | [![npm version](https://img.shields.io/npm/v/@foadonis/sentinel?color=brightgreen)](https://npmjs.com/package/@foadonis/sentinel)         | Authentication building blocks for AdonisJS: email verification, password management and magic links | [Source](https://github.com/FriendsOfAdonis/FriendsOfAdonis/tree/main/packages/sentinel)     | [Documentation](https://friendsofadonis.com/docs/sentinel)     |
