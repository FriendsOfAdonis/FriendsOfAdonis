      ...
      <>
        ...
        <div className="pt-4 h-full flex flex-col">
              ...
              <div className="flex flex-row gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-sand-11 group-hover:text-sand-12 transition ease-in-out duration-700">
                    Dive into the official documentation to learn AdonisJS. Read carefully to
                    discover an unmatched set of features, best practices and developer experience.
                    Through examples, guides and API references, you'll find everything you need to
                    build your next project. From installation to deployment, we've got you covered.
                  </p>
                </div>
              </div>
            </article>
          ...
          <div className="text-sm text-center [&>code]:font-medium [&>code]:text-[#a599ff] bg-sand-12 text-sand-1 fixed bottom-0 left-0 right-0 py-2">
            Route for this page is registered in <code>app/controllers/welcome_controller.tsx</code>{' '}
            file, rendering <code>app/spark/pages/welcome_page.tsx</code> template
          </div>
        </div>
      </>
    )
