...
description: "Set up Sentry error and performance monitoring in AdonisJS: create instrument.ts, enable the Knex integration for Lucid, report from your exception handler."
