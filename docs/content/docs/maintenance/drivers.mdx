---
title: 'Drivers'
description: "Configure the file or cache driver in config/maintenance.ts to store maintenance state, or extend MaintenanceDriver to build your own custom driver"
---
