---
title: 'Commands'
description: "Every Crypt Ace command in one place: crypt:init to create a keypair, crypt:set and crypt:get to write or read encrypted values, all scoped with --env."
---
