...
description: "Install @foadonis/crypt, generate a keypair with crypt:init, encrypt your first secret, and gitignore the .env.keys file holding your private key."
icon: Rocket
---
