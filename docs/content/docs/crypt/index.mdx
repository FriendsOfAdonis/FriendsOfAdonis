---
title: 'Introduction'
description: "AdonisJS Crypt encrypts your .env values with a public key so dotenv files can be committed safely, then decrypts them at boot through @adonisjs/env."
icon: Album
---
