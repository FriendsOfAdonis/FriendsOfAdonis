...
✔ Assymetric cryptography for security and simplified worklow
...
By using assimetric cryptography, your developers can encrypt new secrets without being able to read existing one.
...
When starting your Adonis application, Crypt will decrypt your environment variables automatically for you.
