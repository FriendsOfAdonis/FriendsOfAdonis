...
description: "Build your own Magnify engine by extending MagnifyEngine with update, delete, search, map, paginate and flush, then register it in config/magnify.ts."
---
