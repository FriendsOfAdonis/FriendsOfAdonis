---
title: 'Introduction'
description: "AdonisJS Magnify adds driver based full-text search to your Lucid models: a Searchable mixin keeps Algolia, Meilisearch and Typesense indexes in sync."
icon: Album
---
