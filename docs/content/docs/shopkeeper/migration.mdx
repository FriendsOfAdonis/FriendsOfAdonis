...
description: "Upgrade @foadonis/shopkeeper from 0.1.x to 1.0.0: factory mixins such as billable(), the new checkout and invoice builders, and Stripe SDK v20 changes."
icon: ArrowUp
---

This guide covers all breaking changes when upgrading from `@foadonis/shopkeeper` 0.1.x to 1.0.0.

## Update dependencies

```package-install
npm install @foadonis/shopkeeper@^1.0.0 stripe@^20.4.1
```
