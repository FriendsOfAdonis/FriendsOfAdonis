---
title: Introduction
description: "AdonisJS Shopkeeper gives Stripe billing a fluent, expressive API so you can add subscriptions, trials, one-off charges, and invoices in minutes."
icon: Album
---
