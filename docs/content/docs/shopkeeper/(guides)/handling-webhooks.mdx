...
description: "Keep your database in sync with Stripe via registerRoutes() and registerWebhookListeners(), the shopkeeper:webhook Ace command, and idempotent webhookAudit()."
icon: Webhook
---
