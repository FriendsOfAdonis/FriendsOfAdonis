...
description: "Redirect customers to Stripe Checkout from AdonisJS: product and subscription sessions, promotion codes, checkoutCharge, tax IDs, and guest checkouts."
icon: ShoppingCart
---
