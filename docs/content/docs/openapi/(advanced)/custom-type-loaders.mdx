---
title: Custom Type Loaders
description: "A TypeLoaderFn turns a constructor the generator does not know, such as Luxon DateTime, into a SchemaObject, or stores a component and returns a $ref."
---
