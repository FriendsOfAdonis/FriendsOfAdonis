---
title: Generic Types
description: "Mixins let a single PaginatedResponse factory build reusable AdonisJS OpenAPI schemas, shown here wrapping Lucid paginator meta around any model."
---
