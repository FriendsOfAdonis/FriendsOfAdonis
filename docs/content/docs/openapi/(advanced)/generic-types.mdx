---
title: Generic types
description: 'Use generic types and mixins to reduce code duplication in your AdonisJS OpenAPI schemas for paginated responses and reusable patterns.'
---
...
<Callout type="info">
  When using the [Transformers feature](/docs/openapi/transformers) the paginated schema is
