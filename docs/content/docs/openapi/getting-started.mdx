...
description: "Decorate an AdonisJS controller and model with @foadonis/openapi, call registerRoutes(), then browse the generated specification on /api, /api.json or /api.yaml."
icon: Rocket
---
