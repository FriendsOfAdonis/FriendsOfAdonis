...
description: "Implement AsController to turn an action into an AdonisJS route handler, validate the request from HttpContext and inject services through the container"
---
