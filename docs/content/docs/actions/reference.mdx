---
title: 'Reference'
description: "API reference for AdonisJS Actions: BaseAction, the AsController, AsCommand and AsListener interfaces, loader, ActionsRunner, make:action and indexActions"
icon: Braces
---
