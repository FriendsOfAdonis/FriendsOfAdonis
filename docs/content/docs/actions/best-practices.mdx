...
description: "Naming conventions, folder layout and composition patterns for actions, plus keeping business logic in handle and calling actions instead of emitting events"
---
