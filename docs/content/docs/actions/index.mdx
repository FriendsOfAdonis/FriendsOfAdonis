---
title: 'Introduction'
description: "AdonisJS Actions encapsulates business logic in single-purpose BaseAction classes you can reuse as HTTP controllers, Ace commands and event listeners"
icon: Album
---
