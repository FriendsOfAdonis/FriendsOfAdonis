...
description: "Add @foadonis/actions to AdonisJS, scaffold a class with make:action, then run it through the static run method or bind it straight to a route handler."
icon: Rocket
---
