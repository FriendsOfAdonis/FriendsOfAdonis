---
title: Resolvers
description: "Define queries, mutations and field resolvers as class methods using @Resolver, @Query, @Mutation and @Arg, with AdonisJS dependency injection built in"
---
