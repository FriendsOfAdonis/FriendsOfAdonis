---
title: Authorization
description: "Protect queries, mutations and object fields with @Authorized, AdonisJS Bouncer abilities and policies, and read the logged in user via @CurrentUser or @Ctx"
---
