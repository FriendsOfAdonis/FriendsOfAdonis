...
GraphQL resolvers are autoloaded, meaning that you do not need to manually register them. In addition the autoloading supports Hot Module Reloading thanks to [https://github.com/Julien-R44/hot-hook](hot-hook).
