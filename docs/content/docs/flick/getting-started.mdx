...
description: "Set up @foadonis/flick end to end: configure the memory driver, compose the HasFeatures mixin into a model, and resolve a flag with flick.for(user)."
icon: Rocket
---
