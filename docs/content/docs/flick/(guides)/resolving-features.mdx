...
description: "Read flags through flick.for(scope) with isActive, value, values and match, then write or remove stored values with define, activate, deactivate and clear."
icon: ToggleRight
---
