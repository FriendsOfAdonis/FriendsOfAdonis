...
description: "Swap real resolution for flick.fake(), pin flags with override, and assert what your code checked using assertResolved and assertResolvedFor in Japa."
icon: FlaskConical
---
