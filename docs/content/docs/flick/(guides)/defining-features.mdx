...
description: "Feature classes extend BaseFeature and return booleans or variants from resolve, short-circuit with before(), and identify scopes via FeatureScopeable."
icon: Flag
---
