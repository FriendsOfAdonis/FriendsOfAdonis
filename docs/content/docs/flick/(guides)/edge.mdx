...
description: "Gate markup in Edge templates with the @feature and @featureInactive tags, or read variant values through the flick global that AdonisJS Flick registers."
icon: LayoutTemplate
---
