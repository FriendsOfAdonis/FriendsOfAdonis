...
export async function GithubInfo({
  ...
  return (
    <a
      ...
      {...props}
      className={cn(
        'flex flex-col gap-1.5 p-2 rounded-lg text-sm text-fd-foreground/80 transition-colors lg:flex-row lg:items-center lg:justify-center hover:text-fd-accent-foreground hover:bg-fd-accent',
        props.className
      )}
    >
