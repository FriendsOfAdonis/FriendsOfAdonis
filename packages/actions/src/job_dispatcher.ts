 ...
 *
 * TODO: Remove once it is exported from the package.
 *
 * @see https://github.com/boringnode/queue/blob/main/src/job_dispatcher.ts
 */

import { randomUUID } from 'node:crypto'
import { QueueManager } from '@adonisjs/queue'
import type { Adapter, DispatchResult, Duration } from '@adonisjs/queue/types'
import debug from './debug.ts'

import { parse as parseDuration } from '@lukeed/ms'
import { errors } from '@boringnode/queue'

function parse(duration: Duration): number {
